...
class Index extends Controller {
    ...
    function __construct() {
        parent::__construct();
        #Comment:  if isAdmin(SuperAdmin) will disregard the Auth::handlelogin to avoid password authentication. This will
        # allow the admin to access an account.
    ...
    function index() {
        ...
        $this->JavaScript[] = DASHBOARD_ASSETS . "/vendors/js/charts/apexcharts.min.js";
        $this->JavaScript[] = DASHBOARD_ASSETS . "/js/pages/dashboard.js";
        $this->JavaScript[] = DASHBOARD_ASSETS . "/js/custom.js";
            $this->view->JavaScript = $this->JavaScript;

        $this->Styles['commenta'] = '<!-- Page CSS -->';
        $this->Styles[] = DASHBOARD_ASSETS. '/js/charts/apexcharts.css';
        $this->Styles[] = DASHBOARD_ASSETS. '/css/plugins/charts/chart-apex.css';
        $this->Styles[] = DASHBOARD_ASSETS. '/css/pages/dashboard.css';
