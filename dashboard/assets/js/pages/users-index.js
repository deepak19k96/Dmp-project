/*=========================================================================================
    File Name: users-index.js
    Description: User List page
    --------------------------------------------------------------------------------------
    Item Name: SeedProject - Dashboard
    Author: Carlos Arias
    Author URL: https://www.carlosarias.com
...
$(function () {
    ...
    var assetPath = '/dashboard/assets/',
        userView = 'users/view/123',
        userEdit = 'users/edit/123';
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        var roleBadgeObj = {
                            ...
                            Marketing: feather.icons['settings'].toSvg({ class: 'font-medium-3 text-warning me-50' }),
                            Premium: feather.icons['database'].toSvg({ class: 'font-medium-3 text-success me-50' }),
                            Freebies: feather.icons['edit-2'].toSvg({ class: 'font-medium-3 text-info me-50' }),
